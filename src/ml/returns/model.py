...
PARAMS = {'data': {'ew_lags': 7.062951987415079,
                   'returns_lags': 4},
          'model': {'bagging_temperature': 2.105034878752561,
                    'depth': 2,
                    'ignored_features': (),
                    'l2_leaf_reg': 3.8653121471403287,
                    'learning_rate': 0.0383339930899985,
                    'one_hot_max_size': 2,
                    'random_strength': 0.24399530949415463}}
