...
PARAMS = {'data': {'ew_lags': 13.808819341837774,
                   'returns_lags': 0},
          'model': {'bagging_temperature': 1.1427663665461492,
                    'depth': 4,
                    'ignored_features': (),
                    'l2_leaf_reg': 9.543827875241039,
                    'learning_rate': 0.048970430816177614,
                    'one_hot_max_size': 2,
                    'random_strength': 0.9800269970675916}}
